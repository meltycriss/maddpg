...
def model_level(root, intervals, train, test):
    # model level
    # train data
    if train:
    ...
    for subfolder in subfolders:
        ...
        repeat_level(path, intervals, train, test)

def repeat_level(root, intervals, train, test):
    # train data
    if train:
...
args = get_args()
if args['level']=='model':
    model_level(args['path'], args['interval'], args['train'], args['test'])
elif args['level']=='repeat':
    repeat_level(args['path'], args['interval'], args['train'], args['test'])
